...
- ⏳ RESTE (P.R. suivants) : Finance (cartes stats + mini-graphe Recharts), barres (Sidebar/Header/BottomNav raffinées), boutons/badges/case/progression/champs (composants ui), Home (hero + cartes), et appliquer le format page-Notion (lecture+crayon) aux LIVRABLES/blocs calendrier (NotePanel). Recettes exactes dans design_handoff_creative_space/README.md sections 2.3, 2.5, 2.6, 2.7.
