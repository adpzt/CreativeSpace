...
**⚠️ MOBILE = PROCHAIN GROS CHANTIER (03/07)** : la version mobile est actuellement **pleine de bugs** (overlays/panneaux qui débordent, calendrier illisible, nav du bas, tailles). Tout le peaufinage 02-03/07 a été fait **desktop d'abord**. On attaque maintenant le mobile : plan détaillé dans **roadmap.md → PHASE 8 — Mobile**.
